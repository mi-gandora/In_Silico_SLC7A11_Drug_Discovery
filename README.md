...
* **Platform:** Schrödinger Maestro Suite (Desktop Version)
* **Environment:** Windows 11 
* **Key Modules:** Protein Preparation Wizard, LigPrep, QikProp (ADMET), Phase (Pharmacophore), Glide (Molecular Docking), Prime MM-GBSA, Lead Optimization
